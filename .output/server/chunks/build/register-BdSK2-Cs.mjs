  ...
  setup(__props) {
    ...
    async function handleRegister() {
      ...
      try {
        ...
        error.value = ((_a = err == null ? void 0 : err.data) == null ? void 0 : _a.error) || "Registration failed";
      } finally {
        loading.value = false;
      }
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900" }, _attrs))}><div class="max-w-md w-full space-y-8 p-8"><div class="text-center"><h2 class="text-3xl font-bold text-gray-900 dark:text-white"> Create your account </h2><p class="mt-2 text-sm text-gray-600 dark:text-gray-400"> Already have an account? `);
            ...
            _push2(ssrRenderComponent(_component_UFormGroup, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<p class="text-xs text-gray-500 mt-1"${_scopeId2}> Password must be at least 6 characters long </p>`);
                } else {
                  return [
                    createVNode(_component_UInput, {
                      modelValue: unref(form).password,
                    ...
                    createVNode("p", { class: "text-xs text-gray-500 mt-1" }, " Password must be at least 6 characters long ")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=register-BdSK2-Cs.mjs.map
