...
import { defineComponent, ref, computed, toRaw, watchEffect, nextTick, provide, h as h$1, Fragment, inject, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, renderList, createTextVNode, Transition, toRef, watch, useId, useSSRContext } from "vue";
import { i as it, r as rt, u as ut, n as nt, l as lt } from "./combobox-CuaG0EPH.js";
import { d, e } from "./form-DsUILy5F.js";
import { i, u, o, A as A$1, N, E, T, a as o$1, s as s$1 } from "./keyboard-Duq8EHr3.js";
import { w } from "./use-outside-click-DgYwH73n.js";
import { s } from "./use-resolve-button-type-BNXbruUH.js";
import { p } from "./use-text-value-CfKvyAwN.js";
import { u as u$1, c, f as f$1 } from "./calculate-active-index-Dujs8zvP.js";
import { f, u as u$2 } from "./hidden-Dc_fFmis.js";
import { l, i as i$1, t } from "./open-closed-BDzQJ33n.js";
import { w as w$1, h, O } from "./focus-management-vHH7q6nP.js";
import { d as computedAsync } from "./index-CdtLKm1D.js";
import { defu } from "/workspaces/website-poc-glm/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
import { _ as _export_sfc, m as mergeConfig, t as twMerge, d as twJoin, c as appConfig, q as get } from "../server.mjs";
import { u as useUI, s as select, b as selectMenu } from "./tooltip-CPSmt-Rg.js";
import { u as usePopper } from "./usePopper-BrvKSG9Z.js";
...
import { u as useDebounceFn } from "./index-BLXEZ1Ia.js";
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o$12, { slots: b, attrs: r, emit: w$2 }) {
  ...
  w([f$2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$1(i2, h.Loose) || (t2.preventDefault(), (l2 = o(f$2)) == null || l2.focus());
  ...
  return () => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I, Q]) => h$1(f, E({ features: u$2.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h2, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
    ...
    switch (a.key) {
      ...
      case o$1.ArrowDown:
        a.preventDefault(), e2.openListbox(), nextTick(() => {
          var u2;
          (u2 = o(e2.optionsRef)) == null || u2.focus({ preventScroll: true }), e2.value.value || e2.goToOption(c.First);
        });
        break;
      case o$1.ArrowUp:
        a.preventDefault(), e2.openListbox(), nextTick(() => {
          var u2;
          (u2 = o(e2.optionsRef)) == null || u2.focus({ preventScroll: true }), e2.value.value || e2.goToOption(c.Last);
        });
        break;
    }
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.22.3_magicast@0.5.0_tsx@4.20.6_vite@7.1.12_@types+node@20.19.24_jiti@2.6.1_t_32e2b60713db3d07f60c2d3c3af648d7/node_modules/@nuxt/ui/dist/runtime/components/forms/SelectMenu.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SelectMenu = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  SelectMenu as default
};
//# sourceMappingURL=SelectMenu-CGnJIN57.js.map
