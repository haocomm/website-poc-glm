...
import __nuxt_component_3$1 from "./Modal-C5lvBGMH.js";
import __nuxt_component_4 from "./Card-Bg1XFqAv.js";
import __nuxt_component_1$1 from "./Form-C-6Cuk9j.js";
import __nuxt_component_2$1 from "./FormGroup-BHNbwERn.js";
import __nuxt_component_7 from "./Textarea-DvyjjE0a.js";
...
import "./transition-SVkoAT_R.js";
import "./portal-BoVYkj6E.js";
...
import "./description-BmqggpRU.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(rooms), (room) => {
        ...
        ])}"><div class="font-medium text-gray-900 dark:text-white">${ssrInterpolate(room.name)}</div><div class="text-sm text-gray-500 dark:text-gray-400">${ssrInterpolate(room.members?.length || 0)} members </div></div>`);
      });
      ...
      if (!unref(currentRoom)) {
        ...
        ssrRenderList(unref(messages), (message) => {
          _push(`<div class="mb-4"><div class="flex items-start space-x-3"><div class="flex-shrink-0"><div class="w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center"><span class="text-white text-sm font-medium">${ssrInterpolate(message.username?.[0]?.toUpperCase())}</span></div></div><div class="flex-1"><div class="flex items-center space-x-2"><span class="font-medium text-gray-900 dark:text-white">${ssrInterpolate(message.username)}</span><span class="text-xs text-gray-500 dark:text-gray-400">${ssrInterpolate(formatTime(message.timestamp))}</span></div><div class="text-gray-700 dark:text-gray-300">${ssrInterpolate(message.content)}</div></div></div></div>`);
        });
...
//# sourceMappingURL=chat-CTElLWzL.js.map
