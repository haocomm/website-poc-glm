import { ImportsMap, appendExtensionListToPattern, asRoutePath, joinPath, logTree, mergeAllExtensions, mergeRouteRecordOverride, resolveOptions, throttle, warn } from "./options-BQdPq-CI.js";
...
`;
	...
	const isPiniaColadaInstalled = isPackageExists("@pinia/colada");
...
//#endregion
export { AutoExportLoaders, EditableTreeNode, VueRouterAutoImports, createRoutesContext, createTreeNodeValue, src_default };