import { computed, unref, shallowRef, watch, triggerRef, onScopeDispose, defineComponent, ref, inject, watchEffect, nextTick, h, provide, Fragment, cloneVNode, toRaw, reactive } from "vue";
import { d, e } from "./form-DsUILy5F.js";
import { o, t as t$2 } from "./active-element-history-Cer4cSOw.js";
import { i as i$1, o as o$1, A, N, T, u as u$1, E, a as o$2 } from "./keyboard-Duq8EHr3.js";
import { w, n } from "./use-outside-click-DgYwH73n.js";
import { s } from "./use-resolve-button-type-BNXbruUH.js";
import { u, i as i$4, c, f as f$1 } from "./calculate-active-index-Dujs8zvP.js";
import { f, u as u$2 } from "./hidden-Dc_fFmis.js";
import { l, i as i$3, t as t$1 } from "./open-closed-BDzQJ33n.js";
import { i as i$2, O } from "./focus-management-vHH7q6nP.js";
...
let ie = Symbol("VirtualContext"), Ae = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$1 }) {
  ...
  w([e$1, c$1, f$2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$1(computed(() => u$1(o2.value, { [0]: i$3.Open, [1]: i$3.Closed })));
  computed(() => {
    var t2;
  ...
  function M(i2) {
    switch (w2(() => {
      ...
      case o$2.Enter:
        ...
        break;
      case o$2.ArrowDown:
        return i2.preventDefault(), i2.stopPropagation(), u$1(e2.comboboxState.value, { [0]: () => e2.goToOption(c.Next), [1]: () => e2.openCombobox() });
      case o$2.ArrowUp:
        return i2.preventDefault(), i2.stopPropagation(), u$1(e2.comboboxState.value, { [0]: () => e2.goToOption(c.Previous), [1]: () => {
...
//# sourceMappingURL=combobox-CuaG0EPH.js.map
