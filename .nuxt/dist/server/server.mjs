import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, ref, defineComponent, watch, h, nextTick, unref, Suspense, mergeProps, provide, createElementBlock, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
import destr from "/workspaces/website-poc-glm/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
import { withBase, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/workspaces/website-poc-glm/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/workspaces/website-poc-glm/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/workspaces/website-poc-glm/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/workspaces/website-poc-glm/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "/workspaces/website-poc-glm/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
import { defu, defuFn, createDefu } from "/workspaces/website-poc-glm/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
import { klona } from "/workspaces/website-poc-glm/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/workspaces/website-poc-glm/node_modules/.pnpm/@unhead+vue@2.0.19_vue@3.5.22_typescript@5.9.3_/node_modules/@unhead/vue/dist/index.mjs";
...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import("./_nuxt/multipart-parser-DZM4lp0y.js");
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/chat-BcZmjO-D.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CLJyTtY2.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import("./_nuxt/login-BwKuEgzE.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import("./_nuxt/register-yVZh_tIX.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-D9ttKn3c.js")
};
...
const LazyUAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-ByHNoCuZ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUAlert = defineAsyncComponent(() => import("./_nuxt/Alert-D0XQh8HD.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUAvatar = defineAsyncComponent(() => import("./_nuxt/Avatar-BaGAyPcZ.js").then((n2) => n2.A).then((r2) => r2["default"] || r2.default || r2));
const LazyUAvatarGroup = defineAsyncComponent(() => import("./_nuxt/AvatarGroup-3u2Sh6Oa.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUBadge = defineAsyncComponent(() => import("./_nuxt/Badge-DJBXJtNr.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUButton = defineAsyncComponent(() => import("./_nuxt/Button-9ee1Ge7s.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUButtonGroup = defineAsyncComponent(() => import("./_nuxt/ButtonGroup-FtQ0vIY5.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCarousel = defineAsyncComponent(() => import("./_nuxt/Carousel-ayiQkdxG.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUChip = defineAsyncComponent(() => import("./_nuxt/Chip-DMlkJOUa.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUDropdown = defineAsyncComponent(() => import("./_nuxt/Dropdown-BfmAHf87.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUIcon = defineAsyncComponent(() => import("./_nuxt/Icon-DJIseBIh.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-CXwRWb8-.js").then((r2) => r2["default"] || r2.default || r2));
const LazyULink = defineAsyncComponent(() => import("./_nuxt/Link-BPhPgFL9.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUMeter = defineAsyncComponent(() => import("./_nuxt/Meter-M4-mOxOG.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUMeterGroup = defineAsyncComponent(() => import("./_nuxt/MeterGroup-BR_dzA68.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUProgress = defineAsyncComponent(() => import("./_nuxt/Progress-CupOBowZ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCheckbox = defineAsyncComponent(() => import("./_nuxt/Checkbox-DwumBdTT.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUForm = defineAsyncComponent(() => import("./_nuxt/Form-DBlSVJkL.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUFormGroup = defineAsyncComponent(() => import("./_nuxt/FormGroup-Bc-N4XEc.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUInput = defineAsyncComponent(() => import("./_nuxt/Input-BtHmH20k.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUInputMenu = defineAsyncComponent(() => import("./_nuxt/InputMenu-gYrJRzni.js").then((r2) => r2["default"] || r2.default || r2));
const LazyURadio = defineAsyncComponent(() => import("./_nuxt/Radio-CszscW-5.js").then((n2) => n2.R).then((r2) => r2["default"] || r2.default || r2));
const LazyURadioGroup = defineAsyncComponent(() => import("./_nuxt/RadioGroup-DucJAPiJ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyURange = defineAsyncComponent(() => import("./_nuxt/Range-DMyq2WFo.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSelect = defineAsyncComponent(() => import("./_nuxt/Select-Bs3-YJ9O.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSelectMenu = defineAsyncComponent(() => import("./_nuxt/SelectMenu-CogUuuJW.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUTextarea = defineAsyncComponent(() => import("./_nuxt/Textarea-3YysIckj.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUToggle = defineAsyncComponent(() => import("./_nuxt/Toggle-ChsXS2S1.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUTable = defineAsyncComponent(() => import("./_nuxt/Table-CJxtQFgP.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCard = defineAsyncComponent(() => import("./_nuxt/Card-DAjQZbxZ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUContainer = defineAsyncComponent(() => import("./_nuxt/Container-C1jip1zp.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUDivider = defineAsyncComponent(() => import("./_nuxt/Divider-CyvYyDlp.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSkeleton = defineAsyncComponent(() => import("./_nuxt/Skeleton-CvmwtJ48.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUBreadcrumb = defineAsyncComponent(() => import("./_nuxt/Breadcrumb-D1k35iJ-.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCommandPalette = defineAsyncComponent(() => import("./_nuxt/CommandPalette-Cm_B6BD7.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCommandPaletteGroup = defineAsyncComponent(() => import("./_nuxt/CommandPaletteGroup-wg6GDr5a.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUHorizontalNavigation = defineAsyncComponent(() => import("./_nuxt/HorizontalNavigation-CHx61_T-.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUPagination = defineAsyncComponent(() => import("./_nuxt/Pagination-DQmu5e56.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-BE9lnoDm.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUVerticalNavigation = defineAsyncComponent(() => import("./_nuxt/VerticalNavigation-Dg92Slpw.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUContextMenu = defineAsyncComponent(() => import("./_nuxt/ContextMenu-mJHsVfMs.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUModal = defineAsyncComponent(() => import("./_nuxt/Modal-CLpeltua.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUModals = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r2) => r2["default"] || r2.default || r2));
const LazyUNotification = defineAsyncComponent(() => import("./_nuxt/Notification-B6I_Siv-.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUNotifications = defineAsyncComponent(() => import("./_nuxt/Notifications-B6DW5Gd4.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUPopover = defineAsyncComponent(() => import("./_nuxt/Popover-BIoU5jsk.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSlideover = defineAsyncComponent(() => import("./_nuxt/Slideover-Dlg_zOz2.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSlideovers = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r2) => r2["default"] || r2.default || r2));
const LazyUTooltip = defineAsyncComponent(() => import("./_nuxt/Tooltip-BOGAkWwj.js").then((r2) => r2["default"] || r2.default || r2));
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-OpNUjnzO.js").then((r2) => r2["default"] || r2.default || r2));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-W2obLYJ5.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C-pfCPGm.js"));
