...
import { useHead as useHead$1, headSymbol } from "/workspaces/website-poc-glm/node_modules/.pnpm/@unhead+vue@2.0.19_vue@3.5.22/node_modules/@unhead/vue/dist/index.mjs";
...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import("./_nuxt/multipart-parser-DCV9XFfH.js");
...
const _routes = [
  {
    name: "chat",
    path: "/chat",
    component: () => import("./_nuxt/chat-CTElLWzL.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-C50cB9kF.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import("./_nuxt/login-DR9UdHW-.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import("./_nuxt/register-BdSK2-Cs.js")
  }
];
...
const LazyUAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-Cx2ocbwP.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUAlert = defineAsyncComponent(() => import("./_nuxt/Alert-1iaSXcTM.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUAvatar = defineAsyncComponent(() => import("./_nuxt/Avatar-Bo6m4WVK.js").then((n2) => n2.A).then((r2) => r2["default"] || r2.default || r2));
const LazyUAvatarGroup = defineAsyncComponent(() => import("./_nuxt/AvatarGroup-BkbyWfhy.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUBadge = defineAsyncComponent(() => import("./_nuxt/Badge-brJIIkPA.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUButton = defineAsyncComponent(() => import("./_nuxt/Button-CzYLx3lF.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUButtonGroup = defineAsyncComponent(() => import("./_nuxt/ButtonGroup-Dzi-QPvf.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCarousel = defineAsyncComponent(() => import("./_nuxt/Carousel-ttQtgnA2.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUChip = defineAsyncComponent(() => import("./_nuxt/Chip-DxG_Th3I.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUDropdown = defineAsyncComponent(() => import("./_nuxt/Dropdown-CP_QE3vQ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUIcon = defineAsyncComponent(() => import("./_nuxt/Icon-yaeKMBOf.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-B7cyYuGN.js").then((r2) => r2["default"] || r2.default || r2));
const LazyULink = defineAsyncComponent(() => import("./_nuxt/Link-lersgEI5.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUMeter = defineAsyncComponent(() => import("./_nuxt/Meter-DnRUm9c2.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUMeterGroup = defineAsyncComponent(() => import("./_nuxt/MeterGroup-ad_liCcO.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUProgress = defineAsyncComponent(() => import("./_nuxt/Progress-HOb3rd7F.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCheckbox = defineAsyncComponent(() => import("./_nuxt/Checkbox-D_ZDUfZ4.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUForm = defineAsyncComponent(() => import("./_nuxt/Form-C-6Cuk9j.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUFormGroup = defineAsyncComponent(() => import("./_nuxt/FormGroup-BHNbwERn.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUInput = defineAsyncComponent(() => import("./_nuxt/Input-DS-K8VmZ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUInputMenu = defineAsyncComponent(() => import("./_nuxt/InputMenu-Due4Y0DB.js").then((r2) => r2["default"] || r2.default || r2));
const LazyURadio = defineAsyncComponent(() => import("./_nuxt/Radio-BAzEfdp4.js").then((n2) => n2.R).then((r2) => r2["default"] || r2.default || r2));
const LazyURadioGroup = defineAsyncComponent(() => import("./_nuxt/RadioGroup-Ditw39ei.js").then((r2) => r2["default"] || r2.default || r2));
const LazyURange = defineAsyncComponent(() => import("./_nuxt/Range-Bvo4vpY_.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSelect = defineAsyncComponent(() => import("./_nuxt/Select-BXIriLBL.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSelectMenu = defineAsyncComponent(() => import("./_nuxt/SelectMenu-CGnJIN57.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUTextarea = defineAsyncComponent(() => import("./_nuxt/Textarea-DvyjjE0a.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUToggle = defineAsyncComponent(() => import("./_nuxt/Toggle-JvG2BN5H.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUTable = defineAsyncComponent(() => import("./_nuxt/Table-Y0a-x6iR.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCard = defineAsyncComponent(() => import("./_nuxt/Card-Bg1XFqAv.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUContainer = defineAsyncComponent(() => import("./_nuxt/Container-DD15_wKO.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUDivider = defineAsyncComponent(() => import("./_nuxt/Divider-BYujVSOZ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSkeleton = defineAsyncComponent(() => import("./_nuxt/Skeleton-DV12z_Q3.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUBreadcrumb = defineAsyncComponent(() => import("./_nuxt/Breadcrumb-CYgFy__p.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCommandPalette = defineAsyncComponent(() => import("./_nuxt/CommandPalette-DHZGEIT1.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUCommandPaletteGroup = defineAsyncComponent(() => import("./_nuxt/CommandPaletteGroup-CLDvDRC1.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUHorizontalNavigation = defineAsyncComponent(() => import("./_nuxt/HorizontalNavigation-CmUbPyZD.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUPagination = defineAsyncComponent(() => import("./_nuxt/Pagination-BrQWIdR0.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-De2tS5e5.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUVerticalNavigation = defineAsyncComponent(() => import("./_nuxt/VerticalNavigation-Cj_ujC1E.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUContextMenu = defineAsyncComponent(() => import("./_nuxt/ContextMenu-C3fHKL7i.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUModal = defineAsyncComponent(() => import("./_nuxt/Modal-C5lvBGMH.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUModals = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r2) => r2["default"] || r2.default || r2));
const LazyUNotification = defineAsyncComponent(() => import("./_nuxt/Notification-BGILFFHk.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUNotifications = defineAsyncComponent(() => import("./_nuxt/Notifications-Co3UVCoE.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUPopover = defineAsyncComponent(() => import("./_nuxt/Popover-CuQ9bHEC.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSlideover = defineAsyncComponent(() => import("./_nuxt/Slideover-zfokbDbW.js").then((r2) => r2["default"] || r2.default || r2));
const LazyUSlideovers = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r2) => r2["default"] || r2.default || r2));
const LazyUTooltip = defineAsyncComponent(() => import("./_nuxt/Tooltip-BhsPNeTJ.js").then((r2) => r2["default"] || r2.default || r2));
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-0vvINzLF.js").then((r2) => r2["default"] || r2.default || r2));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-5EAl8wvX.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DoGtg4FU.js"));
